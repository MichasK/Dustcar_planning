...
csv_output = "../Reports/" + 'const_' + data_set + ".csv"
order_outpur = "../Reports/" + 'const_' + data_set + ".txt"
...
for i in range(population):
    ...
    first_pop.append(x)
MAX_ITERATIONS = random.randint(240, 350)
cross_propability = random.randint(10, 25)
mutation_propability = random.randint(10, 25)
tournament_size = random.randint(10, 25)
